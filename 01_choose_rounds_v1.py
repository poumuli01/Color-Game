...
class ChooseRounds:
    ...
    def __init__(self):
        ...
        self.three_buttons = Button(self.how_many_frame, fg=button_fg,
                                    bg="#CC0000", text="3 Rounds",
                                    font=button_font, width=10)
        self.three_buttons.grid(row=0, column=0, padx=5, pady=5)

        self.five_buttons = Button(self.how_many_frame, fg=button_fg,
                                   bg="#009900", text="5 Rounds",
                                   font=button_font, width=10)
        self.five_buttons.grid(row=0, column=1, padx=5, pady=5)

        self.ten_buttons = Button(self.how_many_frame, fg=button_fg,
                                  bg="#000099", text="10 Rounds",
                                  font=button_font, width=10)
        self.ten_buttons.grid(row=0, column=2, padx=5, pady=5)
